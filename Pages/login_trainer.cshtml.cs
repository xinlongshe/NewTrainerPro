...
{
    public class login_trainerModel : PageModel
    {
        [TempData]
        ...
        public login_trainerModel(IDapperRepository<Admin> adminDapperRepository, IDapperRepository<Trainee> traineeDapperRepository, IDapperRepository<Trainer> trainerDapperRepository)
        {
